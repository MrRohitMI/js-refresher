...
// Task 2:
const movieTitlesAndImdb = movies.map(
  (movie) => movie.title + " and " + movie.imdbRating,
);
console.log(movieTitlesAndImdb);

// Filtering

// Task 3:

const thrillMovie = movies.filter(
  (movie) => movie.genre === "Thriller" && movie.year > 2000,
);
console.log(thrillMovie);

// Task 4:

const imdbDramaMovie = movies
  .filter((movie) => movie.genre === "Drama")
  .filter((movie) => movie.imdbRating > 8.5);
console.log(imdbDramaMovie);

// Task 5:

const actionMovie = movies.filter(
  (movie) =>
